...
export const balloonLevel: LevelDefinition = {
  ...
  instructions: {
    objective: `Head-bonk the balloon ${BALLOON_CONFIG.passThreshold} times within ${BALLOON_CONFIG.timeLimitMs / 1000} seconds without letting it touch the ground or any cactus spike. Keep juggling after the unlock for bonus hits.`,
    controls: [
