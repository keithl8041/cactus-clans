...
export const camelRaceLevel: LevelDefinition = {
  ...
  instructions: {
    objective: `Race your camel all the way to the finish line before time runs out (${Math.round(CAMEL_RACE_CONFIG.courseTimeLimitMs / 1000)}s). Dodge rocks and cacti; grab water flasks for stamina.`,
    controls: [
